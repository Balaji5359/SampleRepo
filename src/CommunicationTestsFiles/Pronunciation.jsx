...
return (
      ...
      {['Back', 'Practice', 'Pronunciation Test Dashboard', 'Pronunciation Test Leaderboard'].map((t) => (
      <button
      key={t}
      role="tab"
      ...
      <div style={{ fontSize:18, fontWeight:800 }}>Your Pronunciation Test Summary</div>
      </div>
      ...
      <div className="label">Pronunciation Test Points Earned</div>
      ...
      <div className="stat card" style={{ padding:12 }}>
      <div className="label">Total Pronunciation Test Done</div>
      ...
      <div className="stat card" style={{ padding:12 }}>
      <div className="label">Number of Words Pronunciation Test</div>
    ...
    <div style={{ fontWeight:700, fontSize:20, marginBottom:10 }}>Pronunciation Test Bot</div>
    <div style={{ fontSize:15, color:'var(--muted)', marginBottom:20 }}>Read the sentence and speak clearly</div>

    <div style={{ marginBottom:20, padding:16, background:'rgba(255,255,255,0.02)', borderRadius:8 }}>
    <div style={{ fontSize:16, fontWeight:600, marginBottom:8 }}>Read and Repeat:</div>
    ...
    <div style={{ color:'var(--muted)' }}>Ready to speak - Click the mic!</div>
    }
    </div>
    ...
    <div style={{ fontSize:14, color:'var(--muted)', marginBottom:10, fontWeight:600 }}>Recent Pronunciation Test</div>
