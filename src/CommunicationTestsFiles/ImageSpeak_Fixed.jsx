...
function ImageSpeak() {
  ...
  // CORS-free image generation using canvas
  const generateImage = async () => {
    ...
    try {
      ...
      const promptRequestBody = {
        body: {
          message: 'Generate a detailed image description for speaking practice. Include objects, colors, setting, and atmosphere.',
          sessionId: sessionId,
          email: userEmail
        }
      };
      ...
      // Step 2: Create a canvas-based image with the prompt text (CORS-free solution)
      console.log('🎨 Step 2: Creating practice image...');
      ...
      ctx.fillText('Speaking Practice Image', 512, 150);

      // Add prompt text with word wrapping
      ctx.font = '28px Arial';
      ...
      ctx.fillText('Describe this scene in detail', 512, 750);
      
      ctx.font = '24px Arial';
      ctx.fillText('Use your imagination and speaking skills', 512, 800);
      ...
      const generatedImageData = canvas.toDataURL('image/png');
      
      console.log('✅ Practice image created successfully');
      setImageLoadError(false);
      ...
      ctx.font = 'bold 48px Arial';
      ctx.textAlign = 'center';
      ctx.fillText('Practice Image', 512, 400);
      
      ctx.font = '32px Arial';
      ctx.fillText('Describe what you see', 512, 500);
      ctx.fillText('in this placeholder image', 512, 550);
          ...
          <div className="card">
            {generatedImage ? (
              ...
              <div style={{ textAlign: 'center', padding: '60px 20px' }}>
                ...
                >
                  {isGenerating ? (
                    <><span className="loading">⟳</span> Generating Image...</>
                  ) : (
                    'Generate Practice Image'
                  )}
                </button>
                <p className="instruction" style={{ marginTop: '20px' }}>
                  Click the button above to generate a new image for speaking practice.
                </p>
              </div>
            )}
          </div>
