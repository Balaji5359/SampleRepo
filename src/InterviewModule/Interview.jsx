...
import { BookOpen, Target, Sparkles, Code, Rocket, Brain, Briefcase, MessageSquare, ArrowRight, ArrowLeft } from "lucide-react";
                ...
                <div className="container max-w-6xl mx-auto px-4 py-3 flex items-center gap-3 flex-wrap">
                    <div className="flex items-center gap-5 flex-wrap">
                        ...
                        <button
                            ...
                            className="px-3 py-3 rounded-lg bg-muted text-foreground text-sm font-medium hover:bg-muted/80 transition-colors"
                        >
                            Home
                        </button>
{/* 
                    ...
                    <div className="ml-auto flex items-center gap-2 flex-wrap">
                        <span className="interview-badge primary">Interview Hub</span>
            ...
            <div className="container max-w-6xl mx-auto px-4 py-12 md:py-20">
                <div className="text-center mb-16">
                    ...
                    <h1 className="font-heading text-4xl md:text-6xl font-bold text-foreground mb-4 tracking-tight">
                ...
                <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto mb-20">
                    <div
                        className="group cursor-pointer"
                        onClick={() => navigate("/interview/practice")}
                    >
                        <div className="relative overflow-hidden rounded-2xl bg-card border border-border p-8 transition-shadow duration-300 hover:shadow-lg hover:shadow-glow">
                            ...
                            <div className="relative">
                                ...
                                <div className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-primary text-primary-foreground font-semibold text-sm group-hover:shadow-glow transition-all">
                                    Start Practice Mode
                    ...
                    >
                        <div className="relative overflow-hidden rounded-2xl bg-foreground text-background p-8 transition-shadow duration-300 hover:shadow-lg">
                            ...
                            <div className="relative">
                                ...
                                <ul className="space-y-3 mb-8">
                                    {[
                                        ...
                                        <li key={item} className="flex items-center gap-3 text-sm text-background/90">
                                ...
                                <div className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-accent text-accent-foreground font-semibold text-sm transition-all">
                                    Start Test Mode
                                    <span className="group-hover:translate-x-1 transition-transform">-&gt;</span>
                                </div>
                            </div>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {topics.map((topic) => (
                            <div
                                key={topic.label}
                                className="flex items-center gap-3 px-5 py-4 rounded-xl bg-card border border-border hover:border-primary/30 transition-colors"
                            >
