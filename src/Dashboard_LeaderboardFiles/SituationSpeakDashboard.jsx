          ...
          <div className="dashboard-container">
            <div className="session-analytics-view">
              <div className="analytics-header">
                ...
                <h2>Situation Speak Conversation — {selectedSession.sessionId}</h2>
                    ...
                    {selectedSession.audioFiles && selectedSession.audioFiles.length > 0 ? (
                      <div className="media-container">
                        <audio 
                          controls 
                          style={{width: '100%'}}
                          onLoadedData={() => console.log('✅ Audio loaded successfully:', selectedSession.audioFiles[0].url)}
                          onError={(e) => {
                            console.error('❌ Audio failed to load:', selectedSession.audioFiles[0].url);
                  ...
                  <div className="transcript-results">
                    ...
                    <div style={{marginTop: '20px'}}>
                      ...
                      <svg width="100%" height="200" viewBox="0 0 800 200" style={{background: 'rgba(255,255,255,0.02)', borderRadius: '8px'}}>
                        <defs>
                          <linearGradient id="confidenceGradient2" x1="0%" y1="0%" x2="0%" y2="100%">
                            <stop offset="0%" stopColor="#60a5fa" stopOpacity="0.3"/>
                            <stop offset="100%" stopColor="#60a5fa" stopOpacity="0.1"/>
                          </linearGradient>
                        </defs>
