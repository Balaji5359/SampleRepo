...
function PronunciationDashboardContent({ activeSection, userType, testType, userEmail }) {
  ...
  return (
    <div style={{ marginTop: '30px' }}>
      <h2>Pronunciation {activeSection === 'history' ? 'History' : 'Analytics'}</h2>
      {renderFilterHeader()}
      {loading ? (
        ...
        <div className="modal-overlay" onClick={() => setSelectedSession(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3>Pronunciation Details: {selectedSession.sessionId}</h3>
