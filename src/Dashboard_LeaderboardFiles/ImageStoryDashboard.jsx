...
function ImageStoryDashboard() {
  ...
  useEffect(() => {
    const fetchImageStoryData = async () => {
      if (!userEmail) return;
      ...
      <div style={{ padding: '20px', marginTop: '80px' }}>
        <div className="dashboard-main">
          <div className="dashboard-header">
            <h1>Image Story Dashboard</h1>
            <p className="dashboard-subtitle">Create engaging stories from images</p>
          </div>
...
export default ImageStoryDashboard;