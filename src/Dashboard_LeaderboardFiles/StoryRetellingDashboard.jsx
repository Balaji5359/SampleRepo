...
function StoryRetellingDashboard() {
  ...
  useEffect(() => {
    const fetchStoryRetellingData = async () => {
      if (!userEmail) return;
      ...
      try {
        ...
        console.error('Error fetching STORYRETELLING data:', error);
      } finally {
        setLoading(false);
      }
    };
          ...
          <div className="dashboard-container">
            <div className="session-analytics-view">
              <div className="analytics-header">
                ...
                <h2>Story Retelling Conversation — {selectedSession.sessionId}</h2>
                  ...
                  >
                    <div className="session-info">
                      ...
                      <div className="session-details">
                        <span className="session-type">STORYRETELLING</span>
          ...
          <div className="dashboard-container">
            <div className="session-analytics-view">
              <div className="analytics-header">
                ...
                <h2>Story Retelling Analytics — {selectedSession.sessionId}</h2>
              </div>
                    ...
                    {selectedSession.audioFiles && selectedSession.audioFiles.length > 0 ? (
                      <div className="media-container">
                        <audio 
                          ...
                          onError={(e) => {
                            console.error('❌ Story Retelling Audio failed to load:', selectedSession.audioFiles[0].url);
      ...
      <>
        ...
        <div className="dashboard-container">
          <div className="dashboard-main">
            <div className="dashboard-header">
              <button className="back-btn" onClick={() => setActiveSection('main')}>← Back</button>
              <h1>📚 Story Retelling Analytics</h1>
              <div className="theme-selector">
                <label>Theme: </label>
                <select value={theme} onChange={(e) => setTheme(e.target.value)}>
                  <option value="dark">Dark</option>
  ...
  return (
    <>
      ...
      <div className="dashboard-container">
        <div className="dashboard-main">
          <div className="dashboard-header">
            <h1>📚 Story Retelling Dashboard</h1>
            <p className="dashboard-subtitle">Practice retelling stories with clarity and engagement</p>
            <div className="theme-selector">
              <label>Theme: </label>
              <select value={theme} onChange={(e) => setTheme(e.target.value)}>
                <option value="dark">Dark</option>
...
export default StoryRetellingDashboard;